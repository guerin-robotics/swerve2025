...
public class Telemetry {
    ...
    private final StructPublisher<Pose2d> visionRawPosePub = inst.getTable("VisionRaw")
            .getStructTopic("Pose", Pose2d.struct)
            .publish();

    // Publisher for confident vision pose
    private final StructPublisher<Pose2d> visionConfidentPosePub = inst.getTable("VisionConfident")
            .getStructTopic("Pose", Pose2d.struct)
            .publish();
    private final DoubleArrayPublisher visionConfidentCoordinatePub = inst.getTable("VisionConfident")
            .getDoubleArrayTopic("Coordinate").publish();
