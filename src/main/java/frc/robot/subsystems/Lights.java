...
public class Lights extends SubsystemBase {
    ...
    public Color purple = Color.fromHSV(135, 220, 170); // Uses OpenCV HSV values
    public Color gold = Color.fromHSV(23, 242, 214);
    public LEDPattern purpleGoldStep = LEDPattern.steps(Map.of(0, purple, 0.5, gold));
